...
public class Mode extends GraphicsPane implements ActionListener {
	...
	protected int baconSliced = 0, cheeseSliced = 0, eggSliced = 0, scoreCounter = 0, comboCounter = 1, timer = 15,
	...
	protected GImage pauseButton, wall, pineappleLabel = new GImage("src/main/resources/Pineapple_Label.png"),
			...
			gif = new GImage("src/main/resources/gifMainMenu.gif");// comboLabel = new GImage("");
